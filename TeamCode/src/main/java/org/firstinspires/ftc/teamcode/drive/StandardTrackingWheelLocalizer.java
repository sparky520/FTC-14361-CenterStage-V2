...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 10.158668004258784; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = -5.25; // in; offset of the lateral wheel

    public static double X_MULTIPLIER = 1.02397; // Multiplier in the X direction
    public static double Y_MULTIPLIER = 1; // Multiplier in the Y
    // direction
